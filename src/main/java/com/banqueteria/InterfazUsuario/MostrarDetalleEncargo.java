    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(String.valueOf(sqlfecha).equals(this.labelfecha.getText())){
            ...
            try {
                ...
                for(int b=0;b<this.TablaIngEncargo.getRowCount();b++){

                    String nombre = this.TablaIngEncargo.getValueAt(b,0).toString();
                    String cantidad = this.TablaIngEncargo.getValueAt(b,1).toString();
                    String medida = this.TablaIngEncargo.getValueAt(b,2).toString();
